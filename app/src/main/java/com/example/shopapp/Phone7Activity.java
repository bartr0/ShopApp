...
public class Phone7Activity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nav.setOnItemSelectedListener(item -> {
            switch (item.getItemId()) {
                case R.id.action_home:
                    ...
                    startActivity(new Intent(Phone7Activity.this, MainActivity.class));
                    overridePendingTransition(0, 0);
                    return true;

                case R.id.action_cart:
                    Toast.makeText(this, "Cart", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(Phone7Activity.this, SummaryActivity.class));
                    overridePendingTransition(0, 0);
                    return true;
        ...
        white.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    imageView.setImageResource(R.drawable.phone7_white);
                } else {
                    imageView.setImageResource(R.drawable.phone7);
                }
            }
        });
        ...
        imageView.setImageResource(R.drawable.phone7);
        phone_Name.setText("Vertu Ferrari Edition");
        phone_Description.setText(R.string.phone7);

        addtoCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (quantity == 0){
                    Toast.makeText(Phone7Activity.this, "Select minimum 1 piece", Toast.LENGTH_SHORT).show();
                }
                if (quantity>0){
                    Intent intent = new Intent(Phone7Activity.this, SummaryActivity.class);
