...
public class OrderHelper extends SQLiteOpenHelper {
    ...
    public static final String DATABSE_NAME = "phone_shop.db";
    ...
    public void onCreate(SQLiteDatabase db) {
        String SQL_TABLE = "CREATE TABLE " + OrderContract.OrderEntry.TABLE_NAME + " ("
                ...
                +  OrderContract.OrderEntry.COLUMN_ADDON1 + " TEXT NOT NULL, "
                +  OrderContract.OrderEntry.COLUMN_ADDON2 + " TEXT NOT NULL);";
