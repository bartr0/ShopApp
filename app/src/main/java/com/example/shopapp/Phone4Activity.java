...
public class Phone4Activity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nav.setOnItemSelectedListener(item -> {
            switch (item.getItemId()) {
                case R.id.action_home:
                    ...
                    startActivity(new Intent(Phone4Activity.this, MainActivity.class));
                    overridePendingTransition(0, 0);
                    return true;

                case R.id.action_cart:
                    Toast.makeText(this, "Cart", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(Phone4Activity.this, SummaryActivity.class));
                    overridePendingTransition(0, 0);
                    return true;
        ...
        white.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    imageView.setImageResource(R.drawable.phone4_white);
                } else {
        ...
        imageView.setImageResource(R.drawable.phone4);
        phone_Name.setText("Samsung S20 FE");
        phone_Description.setText(R.string.phone4);

        addtoCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (quantity == 0){
                    Toast.makeText(Phone4Activity.this, "Select minimum 1 piece", Toast.LENGTH_SHORT).show();
                }
                if (quantity>0){
                    Intent intent = new Intent(Phone4Activity.this, SummaryActivity.class);
